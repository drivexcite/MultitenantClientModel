...
namespace ClientApiFunctionHost
{
    public class ProxyFunction
    {
        ...
        public async Task<IActionResult> DelegateInvocation([HttpTrigger(AuthorizationLevel.Anonymous, "get", "post", "put", "patch", "options", Route = "{*any}")] HttpRequest request, ILogger log)
        {
